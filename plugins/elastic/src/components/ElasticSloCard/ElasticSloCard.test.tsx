...
import { ElasticSloCard } from './ElasticSloCard';
...
import sloData from '../../mocks/slo.json';

// TODO, write actual tests
describe('ElasticSloCard', () => {
  ...
  it('should render with slo instance ID', async () => {
    elasticApi.fetchSlo.mockResolvedValue({
    ...
    const entity: Entity = {
      ...
      metadata: {
        annotations: {
          ...
          'elastic/slo-id': 'testid/testinstance',
        },
        name: 'backstage',
      },
    };
    ...
    expect(screen.getByText('SLO Target: 99.00%')).toBeInTheDocument();
  });
  it('should render without slo instance ID', async () => {
    elasticApi.fetchSlo.mockResolvedValue({
      baseUrl: 'https://example.com',
      res: sloData,
    });
